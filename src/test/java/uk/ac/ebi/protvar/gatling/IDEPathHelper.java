package uk.ac.ebi.protvar.gatling;
...
public class IDEPathHelper {
  ...
  static {
    try {
      Path projectRootDir = Paths.get(IDEPathHelper.class.getClassLoader()
//          .getResource("gatling.conf").toURI())
        .getResource("application-test.properties").toURI())
