 ...
 * Reference: https://www.ncbi.nlm.nih.gov/datasets/genome/GCF_000001405.40/
 *
 * Revision history:
 ...
 *
 * Note:
 * - GRCh38: No change between the last (p14) and the first version accession-chromosome mapping.
 * - GRCh37: Mapping available only for the last version.
 *
 * Enum representing RefSeq chromosomes for different versions of the human genome.
 * Each enum entry contains the RefSeq accession versions for GRCh38 and GRCh37,
 * along with the chromosome identifier (e.g., "1", "X", "Y", "MT").
 *
