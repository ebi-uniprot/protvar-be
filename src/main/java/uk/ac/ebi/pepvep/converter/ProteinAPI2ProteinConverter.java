...
import uk.ac.ebi.pepvep.model.response.GeneName;
import uk.ac.ebi.pepvep.model.response.Protein;
import uk.ac.ebi.pepvep.utils.Commons;
import uk.ac.ebi.pepvep.model.api.DBReference;
import uk.ac.ebi.pepvep.model.api.DSPName;
import uk.ac.ebi.pepvep.model.api.DSPRecommendedName;
import uk.ac.ebi.pepvep.model.api.DataServiceProtein;
import uk.ac.ebi.pepvep.model.api.ProteinGene;
