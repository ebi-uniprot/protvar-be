...
public class UniprotAPIRepoImpl implements UniprotAPIRepo {
	...
	private static final String GRAPH_API_PEPVEP_SUMMARY_STATS = "graph-api/pepvep/summary_stats";
	...
	public Object[] getPDBe(List<PDBeRequest> requests) {
		...
		UriBuilder uriBuilder = handler.builder().path(GRAPH_API_PEPVEP_SUMMARY_STATS);
